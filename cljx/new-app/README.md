...
Download from https://github.com/new-app/new-app
...
Run the project directly, via `:main-opts` (`-m new-app.new-app`):
...
Run that uberjar:
    ...
    $ java -jar target/net.clojars.new-app/new-app-0.1.0-SNAPSHOT.jar
